		...
		<div class="text-center">
			...
			<div class="panel-body">
				...
				<form id="register-form" role="form" autocomplete="off" class="form"
					method="post" onsubmit="return forgotvalidation()">
					...
					<div class="input-box">
						<span class="details" style="padding-top: 5px;">New
							Password</span> <input type="password" name="newpassword"
					...
					<div class="input-box">
						<span class="details" style="padding-top: 5px;">Confirm
							Password</span> <input type="password" name="newcpassword"
							id="newcpassword" placeholder="Confirm Password "
							style="width: 100%; height: 45px;">
