      ...
      <form action="officer_home_page.jsp"method=""onsubmit="return crivalidation()">
        <div class="user-details">
          <div class="input-box">
            ...
            <input type="Text"name="policestationname"id="policestationname"placeholder="Enter Police Station Name" >
          </div>
          <div class="input-box">
...
<div class="input-box">
            <span class="details">Date of Crime</span>
           
            <input type="date"name="dateofcrime"id="dateofcrime">
          </div>
          <div class="input-box">
  ...
  <br><br>
        ...
        <div class="input-box">
          ...
          <div class="input-box">
            ...
            <input type="jailterm"name="jailterm"id="jailterm"placeholder="Enter the Jail Term" >
          </div>
          <div class="input-box">
